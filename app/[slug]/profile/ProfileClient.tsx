      ...
      <main className="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8 py-8">
        ...
        {(!hasW9 || !hasCoi) && (
          <div className="mb-6 rounded-lg bg-amber-50 border border-amber-200 p-4">
            <h3 className="text-sm font-semibold text-amber-800">Documents Required</h3>
            <p className="mt-1 text-sm text-amber-700">
              You must upload your W-9 and Certificate of Insurance (COI) before you can receive job invitations.
            </p>
            <ul className="mt-2 text-sm text-amber-700 list-disc list-inside">
              {!hasW9 && <li>W-9 form — not uploaded</li>}
              {!hasCoi && <li>Certificate of Insurance (COI) — not uploaded</li>}
            </ul>
          </div>
        )}
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden mb-8">
          <div className="px-6 py-5 border-b border-gray-200">
            ...
            <p className="mt-1 text-sm text-gray-500">Upload your W-9 and Certificate of Insurance.</p>
          </div>
          <div className="px-6 py-5 space-y-5">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-medium text-gray-900">W-9 Form</p>
                  <p className="text-xs text-gray-500">{hasW9 ? 'Uploaded' : 'Not uploaded'}</p>
                </div>
              </div>
              <label className={`inline-flex items-center rounded-md px-3 py-2 text-sm font-medium cursor-pointer transition-colors ${
                ...
                {uploading === 'w9' ? 'Uploading...' : hasW9 ? 'Replace' : 'Upload W-9'}
                <input
                  type="file"
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-medium text-gray-900">Certificate of Insurance (COI)</p>
                  <p className="text-xs text-gray-500">{hasCoi ? 'Uploaded' : 'Not uploaded'}</p>
                </div>
              </div>
              <label className={`inline-flex items-center rounded-md px-3 py-2 text-sm font-medium cursor-pointer transition-colors ${
                ...
                {uploading === 'coi' ? 'Uploading...' : hasCoi ? 'Replace' : 'Upload COI'}
                <input
                  type="file"
                  accept=".pdf,.jpg,.jpeg,.png"
                  className="hidden"
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden mb-8">
          <div className="px-6 py-5 border-b border-gray-200">
            <h2 className="text-lg font-semibold text-gray-900">Company & Personal Information</h2>
          </div>
