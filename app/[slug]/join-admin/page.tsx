...
import { joinAdminAction } from './actions'
...
export default function AdminJoinPage() {
  ...
  const [state, formAction] = useFormState(joinAdminAction, null)
  ...
  return (
    <div className="min-h-screen bg-canvas flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <h2 className="mt-2 text-center text-lg text-gray-600">Create your admin account</h2>
      </div>
