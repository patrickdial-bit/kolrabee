        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
          ...
          <div className="px-6 py-5 space-y-4">
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              ...
              <div>
                <dt className="text-xs font-medium text-gray-500 uppercase tracking-wide">Payout</dt>
              ...
              {showFullDetails && project.accepted_at && (
                <div>
                  <dt className="text-xs font-medium text-gray-500 uppercase tracking-wide">Accepted</dt>
              ...
              {showFullDetails && project.paid_at && (
                <div>
                  <dt className="text-xs font-medium text-gray-500 uppercase tracking-wide">Paid</dt>
            ...
            {showFullDetails && project.companycam_link && (
              <div>
                <dt className="text-xs font-medium text-gray-500 uppercase tracking-wide">CompanyCam</dt>
                <dd className="mt-1">
                  <a
          ...
          <div className="border-t border-gray-200 px-6 py-4 bg-gray-50">
            ...
            {isBeforeAcceptance && showAcceptConfirm && (
              <div className="space-y-3">
                ...
                <div className="flex gap-3">
                  ...
                  >
                    {loading === 'accept' ? 'Accepting...' : 'Yes, Accept'}
                  </button>
                  <button
            ...
            {isAcceptedByMe && project.status === 'accepted' && showCancelConfirm && (
              <div className="space-y-3">
                <p className="text-sm font-medium text-gray-900">
                  Are you sure? This will return the project to available status.
                </p>
                <div className="flex gap-3">
                  <button
