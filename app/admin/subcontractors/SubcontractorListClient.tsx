        ...
        <div className="mb-6">
          <div className="sm:flex sm:items-center sm:justify-between">
            ...
            <div className="mt-4 sm:mt-0 flex items-center gap-3">
              <Tooltip text="Email a subcontractor an invite to create an account and upload their W-9 and COI">
                <button
                  id="tour-invite-sub"
                ...
                {filtered.map((sub) => {
                  ...
                  return (
                    <tr key={sub.id} className={`hover:bg-gray-50 transition-colors ${sub.status === 'deleted' ? 'opacity-50' : ''}`}>
                      ...
                      <td className="px-4 py-3 whitespace-nowrap text-center">
                        {sub.coi_file_url ? (
                          <Tooltip text="Open this subcontractor's Certificate of Insurance in a new tab">
                            <button
                      ...
                      <td className="px-4 py-3 whitespace-nowrap text-center">
                        {sub.w9_file_url ? (
                          <Tooltip text="Open this subcontractor's W-9 tax form in a new tab">
                            <button
                      ...
                      {timeTrackingEnabled && (() => {
                        ...
                        return (
                          <td className="px-4 py-3 whitespace-nowrap text-center">
                            <Tooltip text="Let this subcontractor clock in and out on the job from their phone">
                              <button
                                type="button"
                                role="switch"
                      ...
                      <td className="px-4 py-3 whitespace-nowrap text-center">
                        {sub.status === 'active' ? (
                          confirmDeleteId === sub.id ? (
                            ...
                            <Tooltip text="Deactivate this subcontractor so they stop receiving new invites">
