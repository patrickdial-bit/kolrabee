...
CREATE INDEX IF NOT EXISTS idx_platform_invites_tenant ON platform_invites(tenant_id);

-- RLS
ALTER TABLE platform_invites ENABLE ROW LEVEL SECURITY;

DROP POLICY IF EXISTS "Admins can view their tenant invites" ON platform_invites;
