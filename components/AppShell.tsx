...
function startTour(tourKey: string) {
  window.dispatchEvent(new CustomEvent('kolrabee:start-tour', { detail: { tourKey } }))
}
  ...
  if (props.variant === 'admin') {
    ...
    groups = [
      {
        items: [
          ...
          { href: '/admin/bids', label: 'Bid Board', icon: 'projects', active: pathname.startsWith('/admin/bids') },
          ...
          { href: '/admin/help', label: 'Help', icon: 'help', active: pathname.startsWith('/admin/help') },
    ...
    footer = (
      <div className="space-y-1">
        <button
          ...
          className={footerRow}
          title="Replay the tour for this page"
        >
          ...
          <span className={footerLabel}>Take a tour</span>
        </button>
    ...
    groups = [
      {
        items: [
          ...
          { href: `/${slug}/map`, label: 'Map', icon: 'map', active: isActive(`/${slug}/map`) },
          ...(isCrewLeader
    ...
    footer = (
      <div className="space-y-1">
        ...
        <button
          type="button"
          onClick={() => startTour('sub-dashboard')}
          className={footerRow}
          title="Replay the tour for this page"
        >
          <svg className="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" strokeWidth="1.6" stroke="currentColor">
    ...
    groups = [
      {
        items: [
          ...
          },
          {
            ...
            icon: 'help',
            active: pathname.startsWith('/super-admin/kb'),
          },
        ],
      },
    ]
